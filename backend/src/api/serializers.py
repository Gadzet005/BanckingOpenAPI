...
class TransactionSerializer(serializers.ModelSerializer):
    account_code = serializers.IntegerField(
        source="account_id.account_code", read_only=True
    )
    bank_name = serializers.CharField(source="account_id.bank_id.name", read_only=True)
    bank_code = serializers.IntegerField(
        source="account_id.bank_id.bank_code", read_only=True
    )
...
class AccountSerializer(serializers.ModelSerializer):
    ...
    def get_balance(self, obj):
        ...
        params = {"account_number": obj.account_code}
